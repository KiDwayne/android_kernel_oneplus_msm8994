...
#CROSS_COMPILE	?= ${CCACHE} /home/surajdazz/Documents/aarch64-linux-android-6.x/bin/aarch64-linux-android-
...
HOSTCC       = gcc
HOSTCXX      = g++
HOSTCFLAGS   = -Wstrict-prototypes -Os -fomit-frame-pointer -std=gnu89
HOSTCXXFLAGS = -Os
